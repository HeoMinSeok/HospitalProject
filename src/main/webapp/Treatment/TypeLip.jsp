    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <h1 class="brand-heading">Type of Surgery</h1>
          <p class="intro-text">
...
<section id="page-sample">
  <div class="container content-section text-left">
    <div class="row">
      <h2 class="text-center">Lip</h2>
      <div class="full">
        <img src="../img/typelip4.png">
        <img src="../img/typelip3.png">
        <img src="../img/typelip2.png">
        <img src="../img/typelip1.png">
        <img src="../img/typelip5.png">
