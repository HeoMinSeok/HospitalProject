...
<section id="page-sample">
  <div class="container content-section text-left">
    <div class="row">
      <h2 class="text-center">Eyes</h2>
      <div class="full">
        <img src="../img/typeeyes1.png">
        <img src="../img/typeeyes2.png">
        <img src="../img/typeeyes3.png">
        <img src="../img/typeeyes4.png">
        <img src="../img/typeeyes5.png">
        <img src="../img/typeeyes6.png">
