...
<body>
<form class="form" name="writeFrm" method="post" enctype="multipart/form-data" action="../edit" onsubmit="return validateForm(this);">
    <input type="hidden" name="rbNum" value="${ dto.rbNum }">
    <input type="hidden" name="prevOfile" value="${ dto.rbOfile }">
    <input type="hidden" name="prevSfile" value="${ dto.rbSfile }">
    ...
    <input type="text" class="input" placeholder="제목" name="title" value="${ dto.rbTitle }">
    <textarea name="content" class="input" placeholder="내용">${ dto.rbContents}</textarea>
