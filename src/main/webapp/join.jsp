...
<form action="register" method="post" class="validation-form" novalidate>
  ...
  <div class="row g-3 align-items-center">
    ...
    <div class="col-auto">
      <input type="button" id="datepicker" value="생년월일 선택">
    </div>
    <div class="col-auto">
<%--      <input class="form-control" type="text" name="yy" id="yy" placeholder="년(4자리)" maxlength="4" required>--%>
<%--      <select class="form-select" name="yy" id="yy" aria-label="Default select example" required></select>--%>
      <input type="text" id="yy" name="yy" placeholder="년도">
    </div>
    <div class="col-auto">
<%--&lt;%&ndash;      <input class="form-control" type="text" name="mm" id="mm" placeholder="월" maxlength="2" required>&ndash;%&gt;--%>
<%--      <select class="form-select" name="mm" id="mm" aria-label="Default select example" required></select>--%>
      <input type="text" id="mm" name="mm" placeholder="월">
    </div>
    <div class="col-auto">
<%--&lt;%&ndash;      <input class="form-control" type="text" name="dd" id="dd" placeholder="일" maxlength="2" required>&ndash;%&gt;--%>
<%--      <select class="form-select" name="dd" id="dd" aria-label="Default select example" required></select>--%>
      <input type="text" id="dd" name="dd" placeholder="일">
    </div>
  </div><br/>
